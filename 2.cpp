...
void readin()
{
    ...
    getnum['#']=0;
    chaz[0]='#';
    cout<<"Input terminal character set："<<endl;
    char x;
    do
    {
      cin>>x;
     ...
     chaz[num]=('@');
    cout<<"Input non-terminal character set："<<endl;
    do
    {
      cin>>x;
      getnum[x]=++num;
    ...
    cout<<"Input all formula（symbol of end ‘@’）,input‘end’to end:"<<endl;
    string pro;
